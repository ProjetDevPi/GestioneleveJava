...
public class InscriptionController implements Initializable {
    ...
    @FXML
    private JFXTextField txtniveau;
 ...
 void addE(ActionEvent event) throws SQLException, IOException {
  ...
  if((txtnom.getText().isEmpty()||txtprenom.getText().isEmpty()||txtage.getText().isEmpty()||txtadresse.getText().isEmpty()||txtdate.getValue()==null)||txtniveau.getText().isEmpty())      {
